<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="introWrap">
        <div class="header">
            <div class="logo"><a href="/main.do" title="메인페이지로 이동"><img src="resource/images/logo_white.png" alt="국회도서관 로고"/></a></div>
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><a href="/lowcontent/etccontents/assemblyInfoServiceView.do">입법서비스</a></li>
                    <li><a href="/datasearch/commant/selectWeekCommantList.do">책이야기</a></li>
                    <li><a href="/usermadang/notice/noticeList.do">이용자마당</a></li>
                    <li class="last"><a href="/libintroduce/etc/greetingView.do">도서관소개</a></li>
        ...
        <div class="contents">
            <div class="cell">
                ...
                <div class="searchForm">
                    <form method="get" name="mainVO" id="mainVO" data-ajax="false">
                        <!-- 20190219 추가 -->
                        ...
                        <input type="text" id="query" name="query" value="" title="검색어 입력" onkeydown="javascript:if(event.keyCode == 13) librarySearch(event);" autocomplete="off" />
                        <a href="#none" onclick="openMultiLanguage();" class="btn_lang" title="새창 열림">다국어 입력기</a>
                        <a class="searchBottom" onclick="librarySearch(event);" href="#none"><img src="resource/images/btn_search_white.png" alt="검색"></a>
                    </form>
                </div>
        ...
        <div class="linkArea">
            <ul>
                ...
                <li class="closeday"><a href="/libaryuseinfo/libUseUserTimeView.do">휴관일 안내</a></li>
                <li class="notice"><a href="/usermadang/notice/noticeList.do">공지사항</a></li>
                <li class="map"><a href="/libintroduce/etc/libDirectView.do">오시는 길</a></li>
                <li class="help"><a href="#none" id="floating_box" title="새창열림">물어보세요</a></li>
            </ul>
        </div>
    </div>
