...
<div class="libChk">
	<h1><a href="https://dl.nanet.go.kr:443" onclick="getInSession()" title="국회전자도서관"><img src="/images/ko/logo.png" alt="국회전자도서관"></a></h1>
	<!-- <div class="busanLib">
...
<nav id="gnb" class="pcMenu">
    ...
    <ul>
                ...
                <li><a href="http://www.nanet.go.kr/member/insertMemberForm1.do" target="_blank" title="회원가입">회원가입</a></li>
    ...
    <div class="wrap">
        <div class="menuTop">
            ...
            <div class="mobileMenu2">
						...
						<a href="/login.do?retUrl=/m/main.do" title="로그인">로그인</a>
						<a style="margin-right: 10px;" href="https://www.nanet.go.kr/member/insertMemberForm1.do" target="_blank" title="회원가입">회원가입</a>
        ...
        <ul>
            ...
            <li class="item4"><a href="/mylist/list.do" title="내서재">내서재</a></li>
...
<section id="search">
    ...
    <div class="searchForm">
        <form method="post" id="searchForm" name="searchForm" action="" onsubmit="javascript:putSearchHistory();">
            ...
            <input type="hidden" id="prevQueryText"        name="prevQueryText"        value="자바애플:ALL_NI_TOC:AND">
...
<div class="close">
    <a href="#none" title="닫기">닫기</a>
                ...
                <!-- end : 다국어 page -->
                <input type="text" class="inputText" id="searchQuery" name="searchQuery" onfocus="setFocusIdForMultiLang('searchQuery');this.select();" title="검색 입력창"
                value=" 자바애플" autocomplete="off" placeholder="검색어를 입력해주세요"
                 >
                <div class="autoComplete">
                    <!--  ajax 데이터 처리 영역 -->
                </div>
                <input type="button" value="다국어입력" title="다국어입력" class="searchKeyboard" />
                <input type="submit" id="searchBtn" class="searchBtn" title="검색" value="검색" disabled=disabled />
            </fieldset>
        </form>
	    ...
	    <div class="searchMore">
	    	<ul>
	    		<!--
	    		<li>
	    			<input type="checkbox" id="chkRefineSearchYn1" name="chkRefineSearchYn"/>
	    			<label for="chkRefineSearchYn1">결과 내 검색</label>
	    		</li>
	    		<li>
	    			<input type="checkbox" id="chkSynonymYn1" name="chkSynonymYn"/>
	    			<label for="chkSynonymYn1">동의어 검색</label>
	    		</li>
	    		-->
	    		<li>
	    ...
	    <dl>
	        ...
	        <dd>
	            <ul>
	                        ...
	                        <li><a href="javascript:changeSearchQuery('자바')" title="자바">자바</a></li>
        ...
        <li id="s_menu" class="on">
            ...
            <ol class="secondDepth">
                            ...
                            <li id="s_KINX_ALL" data-api="KINX_ALL" data-api-name="연속간행물&amp;middot;학술기사">
                                ...
                                연속간행물&middot;학술기사<span>26</span>
                                </a>
                ...
                <div>
                    <ul>
                                    ...
                                    <li class="" data-api-type="isdb" data-api="N" data-api-name="원문 없는 자료">
                                        <a href="javascript:changeOrgDoc('isdb', 'N');" title="원문 없는 자료">원문 없는 자료&nbsp;(1)</a>
                                    </li>
                ...
                <div>
	                <ul>
	                        ...
	                        <li class="" data-api-type="language" data-api="KOR" data-api-name="한국어">
	                           <a href="javascript:changeLanguage('KOR');" title="한국어">한국어&nbsp;(1)</a>
	                        </li>
                            ...
                            <ul class="list">
                                            ...
                                            <li>
                                                <span class="num">1.</span>
                                                        ...
                                                        <a href="javascript:searchInnerDetail('MONO1201539978', 'Y')" title="상세 바로가기">RESTful <font color="red">자바</font> 웹 서비스 보안 : 레스트풀 <font color="red">자바</font> <font color="red">애플</font>리케이션의 보안 취약점과 방어 기술 / 르네 엔리케, 안드레 살라자르 지음 ; 이일웅 옮김
                                                    
                                                
                                                
                                                    
                                                    
                                                        <img src="/images/ko/ico/star_0.png" alt="인기도" />
                                                ...
                                                <div class="cart">
	                                                    	...
	                                                    	<input type="checkbox" class="chk" id="chk1" name="chk" title="장바구니" value="MONO1201539978" tabindex="-1"/>
	                                                    
	                                                
                                                    <label for="chk1" tabindex="0">장바구니</label>
                                                </div>
                                                <div class="dataInfo">
...
<!-- 			                                                           <a href="#none" class="infoBtn1 gray" title="인터넷망 PC를 이용하시기 바랍니다.">URL</a> -->
													...
													<!-- 20210616 leedongkun ocr test start -->
<!-- 													<div class="group"> -->
<!-- 														<a	href="#none"  -->
<!-- 															class="infoBtn2"  -->
...
<!-- 													</div> -->
													<!-- 20210616 leedongkun ocr test end -->
                                                    ...
                                                    <!-- 목차 정보 -->
	                                                    ...
	                                                    <div class="group">
	                                                                ...
	                                                                <a href="/PrintText.do?cn=MONO1201539978&pId=TOC&path=L3JlcG8tc3ZjL2V4dHJhL3RvYzAwMS9kYXRhLWRiMS10b2MvbW9ub3RvYzAwMS9Lb3JlYVRvYy8y
MDE1LzIwMTUxMDE2L01PTk8xMjAxNTM5OTc4L01PTk8xMjAxNTM5OTc4LnRvYw==" class="infoBtn2 toc" onclick="showFileContentsPop(this.href, 'TOC', '800', '560', 'Y'); return false;" title="목차">목차</a>
											   ...
											   <!-- KERIS, 20210831 KHJ-->
                                                    ...
                                                    <!--  표지 정보 -->
                                                    	...
                                                    	<div class="group">
	                                                                ...
	                                                                <a href="#none" class="infoBtn2 cov" onclick="viewCoverImg('/storage/repo-svc/extra/cov001/data-db1-cov/cov001/MONO/COVER201510/MONO1201539978.JPG');" title="표지">표지</a>
                                                    ...
                                                    <!-- 저자프로필 정보 -->
                                                    	...
                                                    	<div class="group">
                                                        	<a href="#none" class="infoBtn2 author arrow" onclick="showAuthorProfile(this, 'MONO1201539978')" title="저자프로필">저자프로필</a>

                                                        	<!-- 저자 프로필 -->
			                                                <div class="dStyle2 detail authorDetail" id="AUTHOR_MONO1201539978">
			                                                    <!-- ajax 호출 후, 데이터 처리 -->
			                                                </div>
                                                        </div>
			                                                            		...
			                                                            		<div class="group">
					                                                               			...
					                                                               			<a href="#none" class="infoBtn2 usageStatus arrow" onclick="showUsageStatus('MONO','MONO1201539978')" title="이용현황">이용현황</a>
					                                                               		
					                                                               	
				                                                                	<!-- 이용현황 -->
									                                                <div class="dStyle2 detail usageStatusDetail" id="USAGESTATUS_MONO1201539978">
									                                                    <!-- ajax 호출 후, 데이터 처리 -->
									                                                </div>
				                                                                </div>
												...
												<div class="group">
	                                                <!-- 관련자료보기 -->
	                                                <div class="dStyle2 detail relatedDataDetail">
	                                                    <ul>
	                                                        <li>
	                                                            <div class="btnWrap">
	                                                                <a href="#none" class="btnVD" title="번역문보기">번역문보기</a>
	                                                                <a href="#none" class="btnVD" title="번역문 다운로드">번역문 다운로드</a>
	                                                                <a href="#none" class="btnVD" title="원어문보기">원어문보기</a>
	                                                                <a href="#none" class="btnVD" title="원어문 다운로드">원어문 다운로드</a>
	                                                                <a href="#none" class="btnVD arrow" onclick="viewRelatedDataToc(this);" title="목차">목차</a>
	                                                                <!-- <button type="button" class="btnVD">목차</button> -->
	                                                            </div>
	                                                            <div class="dStyle1 detail depth2 tocDetail2">
	                                                                <div class="box">asdfasdfasdfasdf</div>
	                                                                <div class="more">
	                                                                    <a href="#none" title="더보기">더보기</a>
	                                                                </div>
	                                                                <div class="btnWrap">
	                                                                    <a href="#none" class="btn close" title="닫기">닫기</a>
	                                                                </div>
	                                                            </div>
	                                                        </li>
	                                                    </ul>
...
$(window).load(function(){
	if( winWidth < 1820 && winWidth > 1160 ){
		$(".aside > a.asideBtn.open").removeClass("off");
		$(".aside > a.asideBtn.close").removeClass("on");
		$(".aside .asideBox").removeClass("on");
		$('.aside').addClass("on");
	}else{  }
});
...
$(window).resize(function(){
    ...
    $(document).ready(function(){
		...
		$('.aside > a.asideBtn.open').on('click', function () {
            $('.aside .asideBox').addClass('on');
            $('.aside > a.asideBtn.close').show().focus();
            $('.aside > a.asideBtn.close').addClass('on');
            $('.aside > a.asideBtn.open').addClass('off');
            $('.aside').removeClass("on");
            $("#asideState").val("true");
            return false
        });
        $('.aside > a.asideBtn.close').on('click', function () {
            $('.aside > a.asideBtn.open').show().focus();
            $('.aside .asideBox').removeClass('on');
            $('.aside > a.asideBtn.close').removeClass('on');
            $('.aside > a.asideBtn.open').removeClass('off');
            $('.aside').addClass("on");
        ...
        $('.asideBox>ul>li>a.asideSlideBtn').click(function () {
...
<a href="#" class="asideBtn open">
<span>인포그래픽</span>
<span>추천서비스</span>

<span>국회도서관 정보서비스</span>
</a>
<a href="#" class="asideBtn close">Close</a>
<div class="asideBox">
    <ul>
      ...
      <li class="asideList1">
          <a href="#" title="인포그래픽" class="asideListBtn"><span>인포그래픽</span></a>
      </li>
       ...
       <li class="asideList2 on color">
           <a href="#" title="추천서비스" class="asideSlideBtn"><span>추천서비스</span></a>
           <ul class="serviceList1">
                   ...
                   <li >
                  		...
                  		<a href="javascript:searchInnerDetail('KDMT1200339769')" title="학위논문 바로가기" >
                  			<span class="type dataType2">학위논문</span>
                  			<p class="title"><font color="red">자바</font> <font color="red">애플</font>릿을 이용한 웹기반 디지털 논리 회로 가상실험실</p>
                  		</a>
                   </li>
                   ...
                   <li >
                  		...
                  		<a href="javascript:searchInnerDetail('KINX2016262479')" title="국내기사 바로가기" >
                  			<span class="type dataType2">국내기사</span>
                  			<p class="title"><font color="red">자바</font> <font color="red">애플</font>릿을 이용한 다이오드 기초 회로의 구현</p>
                  		</a>
                   </li>
                   ...
                   <li >
                  		...
                  		<a href="javascript:searchInnerDetail('KDMT1200320836')" title="학위논문 바로가기" >
                  			<span class="type dataType2">학위논문</span>
                  			<p class="title"><font color="red">자바</font> <font color="red">애플</font>릿을 이용한 고등학교 수학 미분 개념학습 시스템</p>
                  		</a>
                   </li>
                   ...
                   <li >
                  		...
                  		<a href="javascript:searchInnerDetail('KDMT1200847537')" title="학위논문 바로가기" >
                  			<span class="type dataType2">학위논문</span>
                  			<p class="title"><font color="red">자바</font> <font color="red">애플</font>릿을 이용한 물리교육 : 전동기 원리를 중심으로</p>
                  		</a>
                   </li>
                   ...
                   <li >
                  		...
                  		<a href="javascript:searchInnerDetail('KINX2007141001')" title="국내기사 바로가기" >
                  			<span class="type dataType2">국내기사</span>
                  			<p class="title"><font color="red">자바</font> <font color="red">애플</font>릿을 이용한 디지털 조합회로의 간략화 과정 구현</p>
                  		</a>
                   </li>
     ...
     <li class="asideList3 on">
         <a href="#" title="국회도서관 정보서비스" class="asideSlideBtn">
             <span>국회도서관  정보서비스</span>
         </a>
         <ul class="serviceList2">
             <li><a href="#none" title="법률정보"><p>법률정보</p><span id="lawCount">0</span></a></li>
             <li><a href="#none" title="국회의원 정책자료"><p>국회의원 정책자료</p><span id="amposCount">0</span></a></li>
             <li><a href="#none" title="국회지방의회 의정정보"><p>국회지방의회 의정정보</p><span id="clickCount">0</span></a></li>
             <li><a href="#none" title="국회기록정보"><p>국회기록정보</p><span id="archivesCount">0</span></a></li>
             <li><a href="#none" title="전문가정보"><p>전문가정보</p><span id="humanCount">0</span></a></li>
             <li><a href="#none" title="지능형분석"><p>지능형분석</p><span id="argosCount">0</span></a></li>
         </ul>
     </li>
