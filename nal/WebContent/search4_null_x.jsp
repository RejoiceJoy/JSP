		...
		$("#showbookinfo").click(function() {
			...
			$.ajax({
				...
				success:function (data, textStatus){	//전송과 응답이 성공했을 경우 작업 설정
					...
					if (jsoninfo.book[1].isNull("book_title")) {
						var bookinfo = "<ul class = 'list'><li class = 'none'><p>";
						bookinfo += "<img src='./images/ko/magnifier.png' /><span>";
						bookinfo += putkeyword + "</span>";
						bookinfo += "에 대한 검색결과가 없습니다.";
						bookinfo += "</p></li></ul>";
					} else {
